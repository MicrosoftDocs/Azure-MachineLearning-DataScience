...
namespace AzureMLClient
{
    public class Configurations
    {
        ...
        public const string AzureStorageConnectionString = "DefaultEndpointsProtocol=https;AccountName=micmancloudmltest2;AccountKey=<your-storage-account-access-key>==";
